(function () {
  window.JEHubSections = {
    ...
    territorios: {
      ...
      styles: ['css/hub-sections/territorios.css?v=2026060991'],
      scripts: [
        'js/territory-column-resize.js?v=2026060919',
        'js/admin/territory-system.js?v=2026060991'
      ],
