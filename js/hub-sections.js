(function () {
  ...
  const AV_SHARED = {
    ...
    partial: 'hub/sections/audio-video.html?v=20260725213000',
    styles: ['css/hub-sections/audio-video.css?v=20260725213000'],
    scripts: [
      'js/admin/audio-video.js?v=20260725213000'
    ],
