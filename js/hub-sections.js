(function () {
  window.JEHubSections = {
    ...
    discursos: {
      ...
      styles: [
        'css/hub-sections/discursos.css?v=20260710233000'
      ],
      scripts: [
        'js/admin/discursos-publicos.js?v=20260710233000'
      ],
    ...
    configuracoes: {
      ...
      styles: ['css/hub-sections/configuracoes.css?v=20260721123000'],
      scripts: [
        'js/admin/table-xlf.js?v=2026061058',
        'js/admin/configuracoes.js?v=20260721123000'
      ],
