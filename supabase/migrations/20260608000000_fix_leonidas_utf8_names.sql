...
SET display_name = convert_from(decode('4a64204c65c3b46e69646173204d6f72656972612041', 'hex'), 'UTF8'),
    slug = 'jardim leonidas moreira a leonidas'
WHERE num = '10';

UPDATE public.territories
SET display_name = convert_from(decode('4a64204c65c3b46e69646173204d6f72656972612042', 'hex'), 'UTF8'),
    slug = 'jardim leonidas moreira b leonidas'
WHERE num = '11';

UPDATE public.territories
SET display_name = convert_from(decode('4a64204c65c3b46e69646173204d6f72656972612043', 'hex'), 'UTF8'),
