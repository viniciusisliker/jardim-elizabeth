-- Aplicar no Supabase: dupla de domingo + designação individual no mesmo dirigente
...
BEGIN
  ...
  PERFORM public.log_territory_history(
    ...
    jsonb_build_object('assignment_id', v_assignment_id, 'is_domingo_pair', v_is_pair)
  );
